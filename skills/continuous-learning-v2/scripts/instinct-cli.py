...
def cmd_evolve(args):
    ...
    # インスティンクトが 3 件以上のクラスタを探す（有力なスキル候補）
    skill_candidates = []
    ...
    # コマンド候補（高信頼度の workflow インスティンクト）
